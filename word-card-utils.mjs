...
export function buildWordCardImageEditPrompt(word, explanation) {
    ...
    return `업로드된 원본 사진 속 핵심 인물 또는 캐릭터를 같은 캐릭터로 유지해 주세요. 얼굴, 머리 모양, 대표 색상, 옷, 장식, 선화와 채색 스타일 등 정체성 특징을 정확히 보존합니다.\n\n단어: "${safe.word}"\n뜻: "${safe.explanation}"\n\n이 캐릭터가 '${safe.word}'의 뜻을 행동이나 사물로 한눈에 보여 주는 교육용 단어 카드 그림으로 편집하세요. 배경은 순백색이고 아주 옅은 바닥 그림자만 허용합니다. 단어와 관련된 핵심 사물과 행동은 크고 명확하게 표현합니다. 캐릭터와 핵심 사물이 잘리지 않게 중앙에 배치합니다. 원본의 교실, 책상, 다른 사람, 이름표와 개인정보는 제거합니다. 글자, 자막, 말풍선, 로고, 워터마크는 넣지 마세요. 정사각형 1:1 고품질 일러스트로 만드세요.`;
}
