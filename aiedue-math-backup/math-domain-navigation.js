  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (tray) {
      tray.innerHTML = `
        ...
        <button class="rpg-action-button rpg-korean-action-button" onclick="location.href='../index.html'">📗 에이두 한글</button>`;
    }

    const lessonRoot = document.getElementById('spiral-lesson-content');
    if (lessonRoot) {
