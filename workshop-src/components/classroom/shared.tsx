...
export function useClassroom():{entries:Entry[];students:Student[];selectedStudent:string;setSelectedStudent:(v:string)=>void;save:SaveEntry;remove:(e:Entry)=>void;busy:boolean}{return useContext(AppContext)}
