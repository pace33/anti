...
assert(app.includes("'ㅖ': [traceRightToLeftStroke(0.4, 0.58, 0.28, { strictDirection: true }), traceRightToLeftStroke(0.62, 0.58, 0.28, { strictDirection: true })") && app.includes('if (strokeItem.stroke.strictDirection)') && app.includes('directionalEndTolerance'), 'ㅖ 가로획이 오른쪽에서 시작해 왼쪽으로 끝나도록 전체 쓰기 판정에 고정되지 않았습니다.');
