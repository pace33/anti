...
assert(app.includes("'ㅖ': [traceLeftToRightStroke(0.4, 0.28, 0.58, { strictDirection: true }), traceLeftToRightStroke(0.62, 0.28, 0.58, { strictDirection: true })") && app.includes('if (strokeItem.stroke.strictDirection)') && app.includes('directionalEndTolerance'), 'ㅖ의 1·2번 가로획이 왼쪽에서 시작해 오른쪽으로 끝나도록 전체 쓰기 판정에 고정되지 않았습니다.');
